...
# Data Harmonization & Differential Expression Analysis
# Generates components for Manuscript Figure 2
# ==============================================================================
...
# ==============================================================================
# Step 1: Data Prep & Publication-Ready Batch Correction (Generates Figure 2A)
# ==============================================================================
...
fig2A <- plot_pre + plot_post + plot_layout(guides = "collect") & theme(legend.position = "bottom")
ggsave("Manuscript_Figures/Figure2A_Batch_PCA.pdf", plot = fig2A, width = 12, height = 6)
ggsave("Manuscript_Figures/Figure2A_Batch_PCA.png", plot = fig2A, width = 12, height = 6, dpi = 600)

saveRDS(list(expr_combat = expr_combat, group_factor = group_factor, batch = batch), "Processed_Data/Step1_ComBat_Data.rds")
message("Step 1 Complete.")

# ==============================================================================
# Step 2: Differential Expression Analysis (Generates Figure 2B and 2C)
# ==============================================================================
...
ggsave("Manuscript_Figures/Figure2B_Volcano.pdf", plot = plot_volcano, width = 7.5, height = 7.5)
ggsave("Manuscript_Figures/Figure2B_Volcano.png", plot = plot_volcano, width = 7.5, height = 7.5, dpi = 600)
...
dev.off()
png("Manuscript_Figures/Figure2C_Heatmap.png", width = 8.5, height = 7.5, units = "in", res = 600)
draw(ht, merge_legend = TRUE)
dev.off()
message("Step 2 Complete. Figure 2 generated.")
